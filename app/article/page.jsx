      ...
      <div className="aboutContainer">
        <div className="me_section mt-[6rem] p-4 sm:p-8">
          <div className="flex flex-col items-center lg:items-start">
            ...
            />
            <h2 className="aboutMe text-2xl sm:text-3xl font-bold mt-4 mb-2 text-center lg:text-left w-full lg:w-[500px]">
              Writing on software and website design, company building, and
              business growth.
            </h2>
            <p className="aboutMeText mt-5 text-sm text-center lg:text-left w-full lg:w-[600px]">
              All of my long-form thoughts on programming, leadership, product
              design, and more, collected in chronological order.
            </p>

            <div className="allArticleTree mt-6 w-full">
